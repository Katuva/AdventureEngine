...
public class CommandResult
{
    ...
    public string? RoomDescription { get; set; }  // Optional room description shown before win/lose screen
    ...
    public static CommandResult Win(string message, string roomDescription) => new() { Success = true, GameWon = true, Message = message, RoomDescription = roomDescription };
